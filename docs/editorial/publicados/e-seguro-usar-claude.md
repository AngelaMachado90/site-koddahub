...
cover_alt: Profissional avalia controles de privacidade enquanto um documento atravessa uma barreira de segurança antes de chegar a um assistente de inteligência artificial
cover_width: 1672
cover_height: 941
image_source:
  provider: OpenAI
